...
export class AlphaBetaPlayer {
    ...
    choose_move(board) {
        ...
        const ret = wasm.alphabetaplayer_choose_move(this.__wbg_ptr, board.__wbg_ptr);
...
export class Board {
     ...
     */
    apply_move_js(r, c) {
        const ret = wasm.board_apply_move_js(this.__wbg_ptr, r, c);
        if (ret[3]) {
     ...
     * @returns {AIMove}
     */
    choose_ai_move(depth) {
        const ret = wasm.board_choose_ai_move(this.__wbg_ptr, depth);
        return AIMove.__wrap(ret);
    }
    /**
     * @returns {Board}
    ...
    from_fen(fen) {
        ...
        const ret = wasm.board_from_fen(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
     ...
     */
    get_history_len() {
        const ret = wasm.board_get_history_len(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    get_last_eval() {
        const ret = wasm.board_get_last_eval(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {Uint32Array}
     */
    get_legal_moves_js() {
        const ret = wasm.board_get_legal_moves_js(this.__wbg_ptr);
        var v1 = getArrayU32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
    ...
    pass() {
        const ret = wasm.board_pass(this.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    to_fen() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.board_to_fen(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
    ...
    to_pgn() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.board_to_pgn(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    undo() {
        const ret = wasm.board_undo(this.__wbg_ptr);
        return ret !== 0;
    }
}
...
export class MinimaxPlayer {
    ...
    choose_move(board) {
        _assertClass(board, Board);
        const ret = wasm.minimaxplayer_choose_move(this.__wbg_ptr, board.__wbg_ptr);
        return AIMove.__wrap(ret);
    }
    /**
     * @param {number} depth
...
const AIMoveFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_aimove_free(ptr, 1));
const AlphaBetaPlayerFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_alphabetaplayer_free(ptr, 1));
...
const MinimaxPlayerFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_minimaxplayer_free(ptr, 1));
